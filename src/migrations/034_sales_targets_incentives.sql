-- Upgrade sales targets safely even if an earlier 033 migration was already applied.
CREATE TABLE IF NOT EXISTS sales_targets (
  ...
  demos_target integer NOT NULL DEFAULT 0,
  won_target integer NOT NULL DEFAULT 0,
  sales_value_target numeric(14,2) NOT NULL DEFAULT 0,
